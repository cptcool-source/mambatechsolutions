# FixedIT Tech — Home Services & Trades Edition (Mock Marketing Site)

A 4-page static mock site for FixedIT Tech, adapted for the home services and field trades
...
- This is a separate site from the medical-office version — same company, same underlying service, different vertical and theme. Keep them in separate repos/folders if running both.
